...
- 三項合併15／30天平均贏幅37.93→43.53%／37.22→41.56%，平均輸幅18.17→15.09%／17.77→15.28%；等權單筆期望6.99→10.69%／7.82→10.61%。中位數略差，不能稱大部分交易變準。
- 金額橋接：15天總獲利少105.79萬、總虧損少221.17萬，實現多115.38萬＋未實現多1.30萬；30天少賺232.68萬、少虧259.16萬，實現多26.48萬＋未實現多4.19萬。期末差116.68／30.67萬全部對帳吻合。
- 實證7610在2026-02-04均通過篩選；次日基準買入順位第10，輪到時現金不足；合併第3而成交，較早參與後續大漲。7610實現收益差51.83／44.49萬，前10大贏家占總獲利比例29%左右→41%左右，優勢集中。此極端漲幅尚未另做獨立價格／公司行動稽核。
- 12組勝率／PF／逐筆損益／帳戶實現未實現恆等式、共同交易金額分解及四組7610現金驗證全部通過；無策略程式變更、無新背景工作。前次commit9b3b2d8，Codex交接；原其他agent未提交檔維持原狀。
